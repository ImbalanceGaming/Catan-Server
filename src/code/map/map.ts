...
export class Map {
    ...
    private _mapTiles           : Array<tile.Tile>;
    ...
    get hexagonWidth():number {
        return this._hexagonWidth;
    }

    set hexagonWidth(value:number) {
        this._hexagonWidth = value;
    }

    get hexagonHeight():number {
        return this._hexagonHeight;
    }

    set hexagonHeight(value:number) {
    ...
    getMapInfo() {
        ...
        this._mapTiles.forEach(function(tile:tile.Tile) {
            tileInfo.push({
                x           : tile.x,
                y           : tile.y,
                type        : tile.type,
