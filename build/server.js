...
io.sockets.on('connection', function (socket) {
    ...
    socket.on('endTurn', function () {
        ...
        var nextPlayer = gameObject.getPlayer(gameObject.turnOrder[gameObject.currentPlayerTurn]);
    ...
    function gameComplete() {
        gameObject.players.forEach(function (playerObject) {
            usersArray.users.forEach(function (userObject) {
        ...
        games.forEach(function (gameInArray, index) {
